  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm text-muted-foreground px-4 py-2 rounded-2xl border border-border bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="animate-slide-up bg-white border-border card-shadow hover:card-shadow-hover transition-all-smooth rounded-2xl" style={{ animationDelay: '0.05s' }}>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
        ...
        <Card className="animate-slide-up bg-white border-border card-shadow hover:card-shadow-hover transition-all-smooth rounded-2xl" style={{ animationDelay: '0.1s' }}>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
        ...
        <Card className="animate-slide-up bg-white border-border card-shadow hover:card-shadow-hover transition-all-smooth rounded-2xl" style={{ animationDelay: '0.15s' }}>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
